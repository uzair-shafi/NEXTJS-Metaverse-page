...
const Hero = () => (
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    ...
    <img 
    src="/cover.png"
    className="w-full sm:h-[435px] h-[350px] object-cover rounded-tl-[140px] z-10 relative top-[12px]"
    />

    <a href="#aboutus">
    <div className="w-full flex justify-end sm:-mt-[75px]  -mt-[50px] pr-[40px] relative z-10">
    <img
    src="/stamp.png" 
    className="sm:w-[115px] w-[100px] sm:h-[115px] h-[100px] object-contain"
    />
    </div>
    </a>
